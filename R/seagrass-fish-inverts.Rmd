...
<!-- First, create version of fish data frame where multiple observations aren't grouped into single rows  -->
<!-- ```{r} -->
<!-- fish_allrows <- fish %>% -->
...
fishlengths$qc_flag <- ifelse(between(fishlengths$length_cm, fishlengths$upper95, fishlengths$lower95), "SVC",
...
^ apparently all the values are acceptable? check this
