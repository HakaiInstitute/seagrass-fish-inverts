...
invertssizes$qc_flag_lengths <- ifelse(between(invertssizes$size_cm, invertssizes$upper95, invertssizes$lower95), "SVC",
                              ifelse(between(invertssizes$size_cm, invertssizes$upper99, invertssizes$lower99), "SVD", "AV"))

# merge QC flags back into OG fish data frame
inverts <- left_join(inverts, (select(invertssizes, "X", "qc_flag_lengths")), on = "X")
```
