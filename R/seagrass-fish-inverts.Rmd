...
fishnames_accepted <- read.csv("../raw-data/names_fish.csv", header = FALSE)
...
invertsnames_accepted <- read.csv("../raw-data/names_inverts.csv", header = FALSE)
...
diversnames_accepted <- read.csv("../raw-data/names_divers.csv", header = FALSE)
...
techsnames_accepted <- read.csv("../raw-data/names_techs.csv", header = FALSE)
