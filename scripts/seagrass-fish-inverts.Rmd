...
```{r}
# FindReplace had trouble with replacing the one name containing parentheses
...
#### Collector and dive tender names 

Update this to match fish/inverts name fixing:
